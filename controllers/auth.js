...
//@desc log current logged in User out
...
exports.logout = asyncHandler(async (req, res, next) => {
  ...
  res.cookie('auth.token', 'none', options);
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  if (!user) {
    return next(new ErrorResponse(`No User with provided email`, 404));
  }
  //get reset token for url
